...
config.command_palette_bg_color = "#131a24"
...
wezterm.on('format-tab-title', function(tab, tabs, panes, config, hover, max_width)
    ...
    local tab_index = tab.is_active and "" or tab.tab_index + 1 .. ": "
    ...
    local softArrow = ""
    if tab.is_active or #tabs == 1 or is_last or tab.tab_index == active_index - 2 then
        softArrow = ""
    else
        softArrow = SOFT_RIGHT_ARROW
    end
    ...
    return {
        ...
        { Text = is_first and "" or SOLID_RIGHT_ARROW },
        ...
        { Background = { Color = trailing_bg } }, { Foreground = { Color = foreground } },
        { Text = softArrow },
    }
end)
