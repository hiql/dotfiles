...
config.font = font({ family = "JetBrainsMonoNL Nerd Font Mono" })
...
local SOLID_REV_RIGHT_ARROW = utf8.char(0xe0d7)
local USER_ACCOUNT = utf8.char(0xf007)
local GRID = utf8.char(0xf15fc)
local ZOOM_IN = utf8.char(0xf50c)

local ACTIVE_TAB_BG = "#c6a0f6"
local ACTIVE_TAB_FG = "#24273a"
local HOVER_TAB_BG = "#f4dbd6"
local HOVER_TAB_FG = "#363a4f"
local NORMAL_TAB_BG = "#363a4f"
local NORMAL_TAB_FG = "#b8c0e0"
local NORMAL_TAB_INDEX_FG = "#ed8796"
local ACTIVE_TAB_INDEX_FG = "#6639d1"
local NORMAL_MUTE_FG = "#6e738d"
local ACTIVE_MUTE_FG = "#494d64"
...
wezterm.on("format-tab-title", function(tab, tabs, panes, config, hover, max_width)
	...
	local tab_idx_left = " ❬"
	local tab_idx_right = "❭ "
	local tab_idx = tostring(tab_index)
...
wezterm.on("update-status", function(window, pane)
	...
	local cell_bg_primary = "#cad3f5"
	local cell_bg_secondary = "#8aadf4"

	window:set_left_status(wezterm.format({
		{ Background = { Color = cell_bg_primary } },
		{ Foreground = { Color = text_fg } },
		{ Text = " " .. USER_ACCOUNT .. " " .. username .. "@" .. hostname .. " " },
		{ Background = { Color = cell_bg_secondary } },
		{ Foreground = { Color = cell_bg_primary } },
		{ Text = SOLID_RIGHT_ARROW },
		{ Background = { Color = cell_bg_secondary } },
		{ Foreground = { Color = text_fg } },
		{ Text = " " .. GRID .. " " .. active_workspace .. " " },
		{ Background = { Color = "none" } },
		{ Foreground = { Color = cell_bg_secondary } },
		{ Text = SOLID_RIGHT_ARROW },
	}))
end)
